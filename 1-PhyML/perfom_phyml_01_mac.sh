...
do
    ...
    do
    {
        ...
        ./PhyML_mac -m GTR -o n -d nt -i ./S101/alignments/$folder/bestMLestimatedgenetree$aligncontract/all-genes_processed$aligncontract.phylip -u ./S101/genetrees/$folder/bestMLestimatedgenetree/estimatedgenetre$contract.gtr.rerooted.final.contracted.non -b -2 -n 1000
    }&
    done
done
